 ...
 *
 */
public class CountTheRepetitionsLeetCode {

    //The problem seemed too contrived to be asked in any interview, so went with brute force and it got accepted.
    //There is a better solution in the discussions. Check it out if doing again.
